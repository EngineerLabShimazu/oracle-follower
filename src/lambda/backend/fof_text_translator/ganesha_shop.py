text_map = {
    ...
    'RECOMMEND_GEM': 'ジェムが{not_enough_gem}個足りないぞう。ジェムパック{gem_pack_grade}を買って、有償ジェムを{paid_gem}個、無償ジェムを{free_gem}個手に入れるぞう？',
    'RECOMMEND_GEM_SMALL': 'ジェムが{not_enough_gem}個足りないぞう。ジェムパック{gem_pack_grade}を買って、有償ジェムを{paid_gem}個手に入れるぞう？',
    'GANESHA_THANKS': 'まいど！',
    'GATCHA_SOUND_1': 'でん!',
    'GATCHA_SOUND_3': 'ででん!',
